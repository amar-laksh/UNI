...
sudo iptables --append FORWARD --protocol tcp --dst $SERVERNET --dport 80 --jump DROP &&
sudo iptables --append FORWARD --protocol udp --dst $SERVERNET --dport 80 --jump DROP
