...
\subsubsection{AES XOR}%
\label{ssub:aes_xor}
The following function implements the required functionality (a complete program can be found in the aforementioned source code repository):
